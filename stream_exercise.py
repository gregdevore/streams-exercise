...
class StreamProcessor(object):
    ...
    def process(self):
        """
        Method to process a stream of digits, two at a time, adding each set of
        digits to a running total.

        Returns:
            count: Int
                The number of digits required to reach a count of at least 200
        """
